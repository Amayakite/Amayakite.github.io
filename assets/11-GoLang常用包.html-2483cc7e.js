import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o,c as p,a as n,b as s,d as i,e as c}from"./app-ef278006.js";const l={},u=n("h2",{id:"golang包大全",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#golang包大全","aria-hidden":"true"},"#"),s(" Golang包大全")],-1),r={href:"https://awesome-go.com/",target:"_blank",rel:"noopener noreferrer"},d=c(`<p>翻译成中文即可，里面有能想到的所有的类型的包</p><h2 id="web层" tabindex="-1"><a class="header-anchor" href="#web层" aria-hidden="true">#</a> Web层</h2><h3 id="gin" tabindex="-1"><a class="header-anchor" href="#gin" aria-hidden="true">#</a> Gin</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>go get github.com/gin-gonic/gin
