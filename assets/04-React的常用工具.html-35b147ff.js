import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as c,c as l,a as n,b as s,d as p,e as a}from"./app-5da40448.js";const i="/images/Web/React/04-React的常用工具/flow.png",u="/images/Web/React/04-React的常用工具/image-20230320211257752.png",r="/images/Web/React/04-React的常用工具/image-20230322190827633.png",k="/images/Web/React/04-React的常用工具/image-20230322194529830.png",d="/images/Web/React/04-React的常用工具/msedge_pHxIbr7fku.gif",v="/images/Web/React/04-React的常用工具/image-20230327191108945.png",m="/images/Web/React/04-React的常用工具/image-20230327191129900.png",b="/images/Web/React/04-React的常用工具/image-20230327191252694.png",g="/images/Web/React/04-React的常用工具/msedge_iEv9JSrU9C.gif",f={},h=n("h2",{id:"immutable-深拷贝",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#immutable-深拷贝","aria-hidden":"true"},"#"),s(" Immutable-深拷贝")],-1),y={href:"https://github.com/immutable-js/immutable-js",target:"_blank",rel:"noopener noreferrer"},w=a(`<p><strong>深拷贝</strong>这里就不多赘述了，有很多实现方式，Immutable给的方式比较另类，详情见例子</p><div class="hint-container tip"><p class="hint-container-title">提示</p><p>如果你还不明白深拷贝是什么，建议去了解下Object</p></div><blockquote><p>安装</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i immutable
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>嘛，感觉整体来说不如一些例如lodash之类的方便，估计是在特定的场合好用...</p><h2 id="mobx" tabindex="-1"><a class="header-anchor" href="#mobx" aria-hidden="true">#</a> Mobx</h2>`,8),x=n("strong",null,"上手简单的状态管理工具",-1),q={href:"https://pinia.vuejs.org/zh",target:"_blank",rel:"noopener noreferrer"},C={href:"https://cn.mobx.js.org/",target:"_blank",rel:"noopener noreferrer"},_=a('<figure><img src="'+i+`" alt="MobX unidirectional flow" tabindex="0" loading="lazy"><figcaption>MobX unidirectional flow</figcaption></figure><p>Mobx实际上运用到的技术和Vue挺像的，利用了Object.defineProperties添加get/set，写法上偏向OOP，且并非单一store，可以多store</p><div class="hint-container tip"><p class="hint-container-title">提示</p><p>Redux默认以Javascript原生对象形式存储数据，而Mobx使用可观察对象</p></div><blockquote><p>优点：</p></blockquote><ul><li>学习成本小</li><li>Typescript友好</li></ul><blockquote><p>缺点</p></blockquote><ul><li>过于自由，Mobx提供的约定比较少，团队编码风格容易不统一</li><li>中间件较少（目前</li></ul><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><p>安装</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> mobx
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>默认是安装5.+的版本，如果需要兼容老的浏览器例如IE11，请安装<code>npm i mobx@4</code></p><h3 id="简单使用" tabindex="-1"><a class="header-anchor" href="#简单使用" aria-hidden="true">#</a> 简单使用</h3><h4 id="了解observable和autorun" tabindex="-1"><a class="header-anchor" href="#了解observable和autorun" aria-hidden="true">#</a> 了解observable和autorun</h4><p>先来一个简单的例子</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> cloneDeep <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;lodash&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="action" tabindex="-1"><a class="header-anchor" href="#action" aria-hidden="true">#</a> action</h3><p>这里有很多种方法，这里先来看看最简单的</p><h4 id="内联action" tabindex="-1"><a class="header-anchor" href="#内联action" aria-hidden="true">#</a> 内联action</h4>`,28),R=n("div",{class:"language-typescript line-numbers-mode","data-ext":"ts"},[n("pre",{ts:"",class:"language-typescript"},[n("code",null,[n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token punctuation"},"{"),s(" observable"),n("span",{class:"token punctuation"},","),s(" action "),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},'"mobx"'),n("span",{class:"token punctuation"},";"),s(`
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="styled-components" tabindex="-1"><a class="header-anchor" href="#styled-components" aria-hidden="true">#</a> Styled-components</h2><h3 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> 概述</h3><p>一句话概括：<code>all in js</code></p><p>虽然不如vue那样方便，但是react中这样做可以很好的实现语法上的css提示</p><p>同时扩展性非常好</p><p>不过主要式锦上添花用的，实际可能并用不上</p><h3 id="安装和快速使用" tabindex="-1"><a class="header-anchor" href="#安装和快速使用" aria-hidden="true">#</a> 安装和快速使用</h3><p>安装</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i styled-components
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+b+`" alt="image-20230327191252694" tabindex="0" loading="lazy"><figcaption>image-20230327191252694</figcaption></figure><h3 id="特性-穿透props" tabindex="-1"><a class="header-anchor" href="#特性-穿透props" aria-hidden="true">#</a> 特性-穿透props</h3><p>例子：</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">&#39;react&#39;</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;react&#39;</span>
<span class="token keyword">import</span> styled <span class="token keyword">from</span> <span class="token string">&#39;styled-components&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+g+`" alt="msedge_iEv9JSrU9C" tabindex="0" loading="lazy"><figcaption>msedge_iEv9JSrU9C</figcaption></figure><h3 id="特性-扩展样式" tabindex="-1"><a class="header-anchor" href="#特性-扩展样式" aria-hidden="true">#</a> 特性-扩展样式</h3><p>可以给任意组件扩展样式 注意这式通过他会传递一个className给对应组件实现的</p><div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">&#39;react&#39;</span>
<span class="token keyword">import</span> styled <span class="token keyword">from</span> <span class="token string">&#39;styled-components&#39;</span>
